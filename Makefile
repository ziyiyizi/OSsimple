...
# Write "boot.bin" & "loader.bin" into floppy image "UINIX.IMG"
# We assume that "UINIX.IMG" exists in current folder
buildimg :
	mount UINIX.IMG /mnt/floppy -o loop
